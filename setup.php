...
function get_sql_schema() {
    ...
    $dependent_tables = [
        "CREATE TABLE IF NOT EXISTS `accounts` (
          ...
          CONSTRAINT `fk_account_partner` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;",
        ...
        // *** FIX 3: Added UNIQUE KEY to prevent duplicate items ***
    ...
    return array_merge($base_tables, $dependent_tables);
}
?>
<!DOCTYPE html>
