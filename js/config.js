...
const AppConfig = {
    API_URL: 'api.php',
    TABLE_STATES: {
        accounts: { currentPage: 1, limit: 10, sortBy: 'id', sortOrder: 'DESC', searchTerm: '' },
        ...
        products: { currentPage: 1, limit: 10, sortBy: 'total_stock', sortOrder: 'DESC', searchTerm: '' },
        ...
        transactions: { currentPage: 1, limit: 15, sortBy: 'date', sortOrder: 'DESC', searchTerm: '', typeFilter: '' },
        settings: { currentPage: 1, limit: 10, sortBy: 'setting_key', sortOrder: 'ASC', searchTerm: '' },
    },
    EXPENSE_CATEGORIES: [
        "اجاره",
        "حقوق و دستمزد",
    ...
    STANDARD_CARPET_DIMENSIONS: ["پادری", "1x1.5", "1.5x2", "1x2", "1x3", "1x4", "1.5x2.25", "1.7x2.4", "2x3", "2.5x3.5", "3x4"]
};